...
const slides = [
  {
    ...
    description:
      "RePromptt teaches you how to unlock the power of AI—no tech skills needed",
    image: images.icon,
  },
  {
    title: "Just Type or Speak",
    description:
      "Share a rough thought, a fuzzy question, or talk naturally—RePromptt listens and adjusts to make it simple for you",
    image: images.avatar,
  },
  {
    title: "Get Better Prompts Instantly",
    description:
      "RePromptt turns your ideas into clear, strong prompts perfect for any AI tool. Copy them and start using them right away!",
    image: images.japan,
  },
  {
    title: "Learn While You Use",
    description:
      "Learn how to get more accurate, helpful replies from AI tools like ChatGPT, Grok, Gemini, and Copilot. No tech skills needed. Just ask.",
